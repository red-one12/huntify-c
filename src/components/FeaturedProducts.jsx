      ...
      axios
        ...
        .then((res) => {
          setProducts((prevProducts) =>
            prevProducts.map((p) =>
              p.name === product.name ? { ...p, votes: p.votes + 1 } : p
            )
          );
        })
        .catch((error) => {
        ...
        {products.map((product, index) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <div className="mt-4">
                <button
                  className={`btn ${user && user.email === product.ownerMail ? 'btn-disabled' : 'btn-primary'}`}
                  disabled={user && user.email === product.ownerMail} 
